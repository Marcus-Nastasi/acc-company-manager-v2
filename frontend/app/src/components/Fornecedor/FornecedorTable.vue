  ...
  methods: {
      async fetchFornecedores() {
         try {
            ...
            alert('Erro ao buscar fornecedores: ' + error)
         }
      },
      ...
      async fetchRegister(item): Promise<void> {
         try {
            ...
            alert('Erro ao criar o fornecedor');
            return;
         } catch (error) {
            alert('Erro na requisição de criação: ' + error);
            return;
         }
      },
                ...
                <v-container>
                  <v-row>
                    ...
                    <v-col cols="12">
                     ...
                     <input style="margin: 5px;" type="checkbox" name="e_pf" id="e_pf" v-model="editedItem.e_pf">
                    </v-col>
                    <v-col cols="12">
                      <v-text-field
